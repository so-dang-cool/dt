...
pub fn builtins() -> Vec<Definition<'static>> {
    vec![
        ...
        // TODO: Should this also work on Quotes?
        Definition::on_state("join", &[Quote, String], &[String], |quote| {
        ...
        Definition::on_state("contains?", &[String, String], &[Boolean], |quote| {
        ...
        Definition::on_state("starts-with?", &[String, String], &[Boolean], |quote| {
        ...
        Definition::on_state("ends-with?", &[String, String], &[Boolean], |quote| {
        ...
        Definition::on_state("to-string", &[A], &[String], |quote| {
